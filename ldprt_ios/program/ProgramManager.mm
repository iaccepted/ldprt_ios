...
{
    NSString *ocFileName = [NSString stringWithUTF8String:fileName];
    NSString *ocPath = [[NSBundle mainBundle] pathForResource:ocFileName ofType:nullptr];
    
	if (!this->fileExits([ocPath UTF8String]))
	{
	...
	const char *source = shaderSourceFromFile([ocPath UTF8String]);
